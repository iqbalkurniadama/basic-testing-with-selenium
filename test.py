...
class TestLogin(unittest.TestCase):
  ...
  # failed username dan password tidak diisi
  def test_b_failled_login(self):
  # steps
    driver = self.browser #buka web browser
    driver.get("https://www.saucedemo.com/") # buka situs
    time.sleep(1)
  ...
  # failed password tidak diisi
  def test_c_failled_login(self):
  # steps
    driver = self.browser #buka web browser
    driver.get("https://www.saucedemo.com/") # buka situs
  ...
  # failed username tidak diisi
  def test_d_failled_login(self):
  # steps
    driver = self.browser #buka web browser
    driver.get("https://www.saucedemo.com/") # buka situs
